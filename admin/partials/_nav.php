    <header class="header" id="header">
        ...
        <div class="header__img">
            <img src="assetsForSideBar/img/akun.png" alt="">
        </div>
    </header>
        ...
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo">
                    ...
                    <span class="nav__logo-name">Warteg Cibadak</span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="index.php?page=categoryManage" class="nav__link nav-categoryManage">
                      ...
                      <span class="nav__name">Daftar Kategori</span>
                    </a>
                    ...
                    <a href="index.php?page=bahanManage" class="nav__link nav-bahanManage">
                      <i class="bx bx-book"></i>
                      <span class="nav__name">Bahan Baku</span>
                    </a>
