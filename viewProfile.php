...
<body>
    ...
    <div class="container">
        ...
        ?>
        <div class="row">
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 30px;margin: 0 auto;">
                <div class="user-info">
                    <img class="rounded-circle mb-3 bg-dark" src="img/person-<?php echo $id_user; ?>.jpg" onError="this.src = 'img/profilePic.jpg'" style="width:215px;height:215px;padding:1px;">
                    <form action="partials/_manageProfile.php" method="POST">
                        <small>Hapus Gambar: </small><button type="submit" class="btn btn-primary" name="removeProfilePic" style="font-size: 12px;padding: 3px 8px;border-radius: 9px;">remove</button>
                    </form>
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="name"><?php echo $nama_depan." ".$nama_belakang; ?>
                            <label class="label label-info">(<?php echo $tipe_user ?>)</label>
                        </li>
            ...
            <div class="content-panel mb-3" style="display: flex;justify-content: center;">
                <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                    <h2 class="title text-center">Profile<span class="pro-label label label-warning"> (<?php echo $tipe_user ?>)</span></h2>
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_depan" name="nama_depan" placeholder="Nama depan" required value="<?php echo $nama_depan ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <b><label for="nama_belakang">Nama Belakang:</label></b>
                            <input type="text" class="form-control" id="nama_belakang" name="nama_belakang" placeholder="Nama belakang" required value="<?php echo $nama_belakang ?>">
                        </div>
                        </div>
                        <div class="form-group">
                            <b><label for="email">Email:</label></b>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan email" required value="<?php echo $email ?>">
                        </div>
                        <div class="form-row">
                            <div class="form-group  col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan no. telepon" required pattern="[0-9]{11}" maxlength="11" value="<?php echo $no_telp ?>">
                                </div>
                            </div>
                            <div class="form-group  col-md-6">
