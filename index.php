...
<body>
  ...
  <!-- Container untuk isi utama dari website -->
  <div class="container my-3 mb-5">
    ...
    <div class="row">
      <!-- SQL untuk menampilkan kategori dari menu Warteg Cibadak -->
      <?php 
        ...
        while($row = mysqli_fetch_assoc($result)){
          ...
          $desc = $row['deskripsi_kategori'];
          echo '<div class="col-xs-3 col-sm-3 col-md-3">
                  <div class="card" style="width: 18rem;">
                    <img src="img/card-'.$id. '.jpg" class="card-img-top" alt="image for this category" width="249px" height="270px">
                    <div class="card-body">
                      <h5 class="card-title"><a href="viewMenuList.php?catid=' . $id . '">' . $cat . '</a></h5>
                      <p class="card-text">' . substr($desc, 0, 70). '</p>
                      <a href="viewMenuList.php?catid=' . $id . '" class="btn btn-primary">View All</a>
                    </div>
                  </div>
                </div>';
        }
