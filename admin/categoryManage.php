                ...
                <div class="card">
                    ...
                    <table class="table table-bordered table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width:58%;">Detil Kategori</th>
                        ...
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td><img src="/Project Warteg/img/card-'.$catId. '.jpg" alt="Gambar untuk kategori ini" width="150px" height="150px"></td>
                                        <td>
                                            <p>Nama : <b>' .$catName. '</b></p>
                                            <p>Deskripsi : <b class="truncate">' .$catDesc. '</b></p>
                                        </td>
...
<?php 
    ...
    while($catRow = mysqli_fetch_assoc($catResult)){
        $catId = $catRow['kategori_id'];
        $catName = $catRow['nama_kategori'];
        $catDesc = $catRow['deskripsi_kategori'];
?>
        ...
        <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                ...
                <div class="form-group col-md-4">
                    <img src="/Project Warteg/img/card-<?php echo $catId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="Category image" width="100" height="100">
                </div>
            </div>
        </form>
        <form action="partials/_categoryManage.php" method="post">
